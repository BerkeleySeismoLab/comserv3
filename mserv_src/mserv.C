 ...
 *
 * Purpose:
 *  Receive multicasted MiniSEED records and provide to client
 *  using the comserv3 client/user interface.
 *
 * Author:
 *   Doug Neuhauser, doug@seismo.berkeley.edu
 *   Adaptded from qmaserv2 by Phil Maechling, Hal Schechner @ ISTI.
 *
 * Created:
 *   2020-05-10
 *
...
int main(int argc, char *argv[]) {
	...
	if(!g_libInterface) {
	    g_libInterface = new LibmsmcastInterface(server_name, g_cvo);
