...
begin
  ...
  loadstring (p, 10, (pointer)gpsstat->time) ;
  loadstring (p, 12, (pointer)gpsstat->date) ;
  loadstring (p, 6, (pointer)gpsstat->fix) ;
  loadstring (p, 12, (pointer)gpsstat->height) ;
  loadstring (p, 14, (pointer)gpsstat->lat) ;
  loadstring (p, 14, (pointer)gpsstat->longt) ;
...
begin
  ...
  storestring (p, 80, (string *)addr(umsg->msg)) ;
end
...
begin
  ...
  loadstring (p, 80, (pointer)addr(umsg->msg)) ;
end
...
begin
  ...
  for (i = 0 ; i <= 8 ; i++)
    loadstring (p, 32, (pointer)addr((*gpsids)[i])) ;
end
...
begin
  ...
  storestring (p, 256, (string *)addr(newweb->dpaddress)) ;
end
...
begin
  ...
  loadstring (p, 236, (pointer)addr(bcfg->opaque)) ;
end
