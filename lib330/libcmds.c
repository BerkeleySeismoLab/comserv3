        ...
        if (q330->cur_verbosity and VERB_PACKET)
          then
            begin /* log the message sent */
              ...
              packet_time (now(), (pointer)addr(s)) ;
...
begin
  ...
  if ((q330->commands.cphase == CP_WAIT) land (q330->commands.cmdin != q330->commands.cmdout))
    then
      begin
        libmsgadd (q330, LIBMSG_CMDABT, (pointer)"") ;
        clear_cmsg (q330) ;
        q330->stat_request = 0 ;
      end
end
...
begin
  ...
  unlock (q330) ;
  libmsgadd (q330, LIBMSG_DEREGWAIT, (pointer)"") ;
end
...
begin
  ...
  libmsgadd (q330, LIBMSG_DEALLOC, (pointer)"") ;
        ...
        if (open_sockets (q330, TRUE, FALSE))
          then
            begin
              ...
              q330->reg_wait_timer = 60 * 10 ;
              q330->registered = FALSE ;
              libmsgadd (q330, LIBMSG_SNR, (pointer)"10 Minutes") ;
              return ;
            end
      end
#endif
    ...
    then
      begin /* log the message received */
        ...
        sprintf(s2, ", Lth=%d Seq=%d Ack=%d", q330->recvhdr.datalength, q330->recvhdr.sequence,
                q330->recvhdr.acknowledge) ;
        strcat(s, s2) ;
        libmsgadd(q330, LIBMSG_PKTIN, (pointer)s) ;
      end
            ...
            then
              begin
                ...
                switch (errcode) begin
                  case CERR_PERM :
                    libmsgadd (q330, LIBMSG_PERM, (pointer)"") ;
                    break ;
                  case CERR_TMSERV :
                  ...
                  case CERR_INVREG :
                    ...
                    sprintf(s, "%d seconds", q330->piu_retry) ;
                    libmsgadd(q330, LIBMSG_INVREG, (pointer)s) ;
                    q330->registered = FALSE ;
                    q330->reg_wait_timer = q330->piu_retry ;
                    break ;
                  case CERR_PAR :
                    libmsgadd(q330, LIBMSG_PARERR, (pointer)"") ;
                    break ;
                  case CERR_SNV :
                    libmsgadd(q330, LIBMSG_SNV, (pointer)"") ;
                    switch (errcmd) begin
                      case C1_RQMEM :
                    ...
                    break ;
                  case CERR_CTRL :
                    libmsgadd(q330, LIBMSG_CMDCTRL, (pointer)"") ;
                    break ;
                  case CERR_SPEC :
                    libmsgadd(q330, LIBMSG_CMDSPEC, (pointer)"") ;
                    break ;
                  case CERR_DB9 :
                    libmsgadd(q330, LIBMSG_CON, (pointer)"") ;
                    break ;
                  case CERR_MEM :
                    libmsgadd(q330, LIBMSG_MEMOP, (pointer)"") ;
                    break ;
                  case CERR_CIP :
                    libmsgadd(q330, LIBMSG_CALPROG, (pointer)"") ;
                    break ;
                end
              end
                  ...
                  if (q330->recvhdr.command == C1_CACK)
                    then
                      begin
                        ...
                        q330->registered = FALSE ;
                        libmsgadd (q330, LIBMSG_DEREG, (pointer)"") ;
                        close_sockets (q330) ;
                      end
                  break ;
                case C1_RQFGLS :
                      ...
                      begin
                        ...
                        if (fgl.lp_off == 0)
                          then
                            begin
                              unlock (q330) ;
                              libmsgadd (q330, LIBMSG_DATADIS, (pointer)"") ;
                              start_deregistration (q330) ;
                              return ;
                            end
                        p = psave ;
                        ...
                        unlock (q330) ;
                        libmsgadd (q330, LIBMSG_COMBO, (pointer)"") ;
                        libmsgadd (q330, LIBMSG_WINDOW, (pointer)addr(s)) ;
                  ...
                  if (q330->recvhdr.command == C1_GID)
                    then
                      begin
                        ...
                        unlock (q330) ;
                        libmsgadd (q330, LIBMSG_GPSID, (pointer)"") ;
                        ...
                        if (req_mask and make_bitmap(SRB_LCHG))
                          then
                            begin /* change in logical port programming */
                              libmsgadd (q330, LIBMSG_LOGCHG, (pointer)"") ;
                              lock (q330) ;
                                              ...
                                              if (lnot((q330->balesim) land ((q330->share.access_timer) lor
                                                ...
                                                then
                                                  begin
                                                    ...
                                                    libmsgadd (q330, LIBMSG_BUFSHUT, (pointer)"") ;
                                                    unlock (q330) ;
                    ...
                    then
                      begin
                        ...
                        if (q330->par_create.q330id_dataport != q330->back.lport)
                          then
                            begin
                              libmsgadd (q330, LIBMSG_WRONGPORT, (pointer)"") ;
                              clear_cmsg (q330) ;
                              return ;
                            end
...
begin
  ...
  if (q330->contmsg[0])
    then
      begin
        libmsgadd (q330, LIBMSG_CONTIN, (pointer)addr(q330->contmsg)) ;
        q330->contmsg[0] = 0 ;
      end
            ...
            if (q330->comtimer > 20)
              then
                begin
                  ...
                  new_state (q330, q330->share.target_state) ;
                  q330->registered = FALSE ;
                  libmsgadd (q330, LIBMSG_DEREGTO, (pointer)"") ;
                  ...
                  if ((q330->par_register.opt_conntime) land (q330->share.target_state != LIBSTATE_WAIT) land
                    ...
                    then
                      begin
                        ...
                        libmsgadd (q330, LIBMSG_CONNSHUT, (pointer)"") ;
                      end
                end
            break ;
          case LIBSTATE_CONN :
