...
extern void lib660_seed_time (tseed_time *st, tsystemtime *greg, longint usec) ;
...
extern void storeopaque (pbyte *pdest, topaque_hdr *ophdr,
...
extern int loadseedhdr_classify (pbyte *psrc, seed_header *hdr, int recsize) ;
